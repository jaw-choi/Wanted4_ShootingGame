...
static const PlayerHitEffect::EffectFrame sequence[] =
{
	PlayerHitEffect::EffectFrame("<+A+>", 0.2f, Color::Red),
	PlayerHitEffect::EffectFrame("<+A+>", 0.2f, Color::White),
	PlayerHitEffect::EffectFrame("<+A+>", 0.2f, Color::Red),
	PlayerHitEffect::EffectFrame("<+A+>", 0.2f, Color::White),
	PlayerHitEffect::EffectFrame("<+A+>", 0.2f, Color::Red)
};

PlayerHitEffect::PlayerHitEffect(const Vector2& position)
...
void PlayerHitEffect::Tick(float deltaTime)
{
